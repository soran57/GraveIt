...
export default function CoffinModal({ grave, onClose, onGraveUpdate, onAuthPrompt }: CoffinModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center font-sans" onClick={onClose}>
        ...
        >
          ...
          <div className="absolute inset-0 overflow-y-auto no-scrollbar">
            ...
            {isHorizontal ? (
              ...
              <div className="pt-10 px-10 pb-16 flex gap-8 items-center h-full min-h-[492px]">
                ...
                <div className="w-1/2 flex flex-col justify-between space-y-5 h-full">
                  ...
                  <div className="space-y-3 pt-4 border-t border-[var(--border-secondary)]">
                    ...
                    {metaRow(<MapPin className="h-4 w-4" />, "PLOT", `(${grave.x_coord}, ${grave.y_coord})`)}
                    {metaRow(<Ruler className="h-4 w-4" />, "SIZE", <span className="uppercase">{grave.size_type} ({grave.width}×{grave.height})</span>)}
              ...
              <div className="px-12 pt-14 pb-6 flex flex-col items-center text-center space-y-6">
                ...
                <p className="text-[var(--text-muted)] text-[13px] leading-relaxed italic max-w-[340px] break-words">
                  &ldquo;{grave.epitaph_text || "No inscription was carved upon this stone."}&rdquo;
                </p>
                ...
                <div className="text-[10px] text-[var(--text-dim)] tracking-wider pt-3 font-mono">
                  {style.name.toUpperCase()} • #{grave.id}
                </div>

                {/* Workaround for flexbox overflow padding-bottom bug */}
